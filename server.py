...
if __name__ == "__main__":
    ...
    # Arranca el scheduler de análisis semanal en un thread de background.
    # Se despierta todos los domingos a las 8am (hora Argentina) y manda el email.
    t = threading.Thread(target=weekly_scheduler.main, daemon=True)
    t.start()
